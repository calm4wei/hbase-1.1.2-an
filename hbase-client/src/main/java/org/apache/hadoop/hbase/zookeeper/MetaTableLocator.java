...
public class MetaTableLocator {
    ...
    public boolean verifyMetaRegionLocation(HConnection hConnection, ZooKeeperWatcher zkw, final long timeout,
        ...
        return (service != null) && verifyRegionLocation(service, getMetaRegionLocation(zkw, replicaId),
    ...
    private boolean verifyRegionLocation(AdminService.BlockingInterface hostingServer, final ServerName address,
        ...
        LOG.info(
                "Failed verification of " + Bytes.toStringBinary(regionName) + " at address=" + address + ", exception="
                        + t.getMessage());
        return false;
    }
    ...
    private static AdminService.BlockingInterface getCachedConnection(HConnection hConnection, ServerName sn)
        ...
        try {
            ...
            } else if (cause != null && cause.getMessage() != null && cause.getMessage().toLowerCase()
